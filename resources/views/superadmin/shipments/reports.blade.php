                    ...
                    <div class="col-sm-12">
                      <div class="card-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 branchDiv hidden">
                                <div class="form-group">
                                    <label>Branch</label>
    ...
    $(document).ready(function () {
        ...
        $(".searchClass").on('click', function() {
            ...
            if(filter == 'shipmentNumber') {
                table.column(2).search( $("#search").val() ).draw();
            } else if(filter == 'Status') {
                var status = $("#status").val();
                var url = "{{route('super-admin.shipment.report.reportStatusData')}}/"+status;
                viewData(url);
            } else if(filter == 'Branches') {
                var search = $("#branch").val();
                table.column(1).search( $("#branch").val() ).draw();
            } else if(filter == 'Date') {
